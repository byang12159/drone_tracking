...
class simulation():
        ...
        try:
            ...
            while not error_event.is_set():
                if mode == "simple_vel":
                    ...
                    client.moveByVelocityBodyFrameAsync(0,5,0, self.timestep, vehicle_name = self.lead)
                    curr_time = time.time()
                    ...
                    print("No matching leader drone mode")               
    ...
    def move_chase(self):
        global timelast, timeinterval, leadkinematiclast
        client = self.client1
        ...
        try:
            ...
            print(f"Exception in thread leader: {e}")
            traceback.print_exc()
            error_event.set() 
